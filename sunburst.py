...
fig = px.sunburst(
        data_frame=df,
        path=["Biofluid", 'Regulation (ALS vs CTL)', "Family","Lipid"],  # Root, branches, leaves
    #color="Family",
...
app.layout = html.Div([
    html.H6("Distribution of differential lipids between ALS patients and control individuals"),
